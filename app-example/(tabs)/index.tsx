import { Image, StyleSheet, Platform, TouchableOpacity, Vibration } from "react-native";
...
export default function HomeScreen() {
  ...
  const stopVibration = () => {
    clearInterval(vibrationInterval.current as unknown as number);
    Vibration.cancel();
  };
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        ...
        onPressOut={stopVibration}
        style={{ height: 50, width: 50, borderRadius: 15, backgroundColor: "white" }}
      />
    </ParallaxScrollView>
  );
}
